  ...
  return (
    <div className="flex flex-col items-center justify-center gap-16">
      ...
      <p>
        ...
        information and diet tracking! Whether you&apos;re looking to make
        informed choices about your meals or maintain a healthy lifestyle,
      ...
      <p>
        ...
        your diet effortlessly. With this valuable tool, you can monitor your
        progress, identify patterns, and make adjustments to achieve your
        wellness goals. Start your nutritional adventure today!
      </p>
    </div>
  );
};
